    ...
    <Layout>
      ...
      {view ? (
        <div className="h-[90vh] sm:h-[85vh] sm:ml-[15%] pt-4 sm:pt-10 relative overflow-hidden">
          <button
            className="border-2 border-[#1aba95] bg-[#1aba95] hover:bg-[#41e2bd] transition-all ease-in-out duration-300 p-2 rounded-full font-semibold text-white absolute sm:right-10 sm:top-0 right-4 z-20 tooltip tooltip-bottom"
            data-tip="Display Cards"
            onClick={() => {
              setView(!view);
            }}
          >
          ...
          <Bubble name="TbBrandNextjs" time="4100" />
          <Bubble name="SiTypescript" time="4300" />
          <Bubble name="TbBrandFirebase" time="4500" />
          <Bubble name="SiGit" time="4900" />
        </div>
      ) : (
        <div className="sm:h-[85vh] flex items-center justify-center overflow-hidden relative">
          <button
            className="border-2 border-[#1aba95] bg-[#1aba95] hover:bg-[#41e2bd] transition-all ease-in-out duration-300 p-2 rounded-full font-semibold text-white absolute sm:right-10 top-0 right-4 z-20 tooltip tooltip-bottom"
            data-tip="Display Bubbles"
            onClick={() => {
              setView(!view);
            }}
          >
