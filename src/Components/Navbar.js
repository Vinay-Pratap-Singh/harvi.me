...
const Navbar = () => {
  return (
    <nav className="flex items-center justify-around text-white font-mono">
      {/* creating the name logo */}
      <div
        className="h-[55px] w-[45px] bg-[#64ffda] flex items-center justify-center my-4"
        style={{
          clipPath:
      ...
      >
        ...
        >
          <a className="font-bold" href="#homepage">V</a>
        </div>
      </div>
